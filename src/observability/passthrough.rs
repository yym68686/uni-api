...
use crate::observability::usage::FactUsage;
use crate::protocols::provider_stream::StreamOutcome;
...
pub(crate) fn observe(
    ...
    let headers = crate::transport::http::filtered_response_headers(response.headers());
